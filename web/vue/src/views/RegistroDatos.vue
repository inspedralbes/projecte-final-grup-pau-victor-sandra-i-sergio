        ...
        <div class="div_datos REGISTRO2 align-items-start shadow-lg">
            <div class="div2 p-5">
                    ...
                    <div class="col-md-7 col-12">
                        <div class="row align-items-center">
                            ...
                            <div class="col-5 col-md-7 g-1">
                                <input type="number" class="form-control" :class="[this.error ? 'error' : '']" id="edad"
                                    :value="edad" min="0" max="100" @input="event => edad = event.target.value" />
                            </div>
                        </div>
                                ...
                                <div class="ocupacion p-3 pe-4 shadow-sm" :class="[this.error ? 'error' : '']">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="Ocupacion" id="trabajador"
                                            value="Trabajo" v-model="this.ocupacion" />
                ...
                <div class="text-center mt-3">
                    <input type="button" class="btn btn-primary text-center" @click="this.enviarDatos()"
                        value="Confirmar">
                </div>
            </div>
        </div>
